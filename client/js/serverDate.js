...
var ServerDate = (function(serverNow) {
    ...
    function synchronize() {
        ...
        function requestSample() {
            ...
            request.open("HEAD", "/ping" + concatenationChar + "noCache=" + Date.now() + parseInt(Math.random() * 1000000));
            ...
            request.onreadystatechange = function() {
                ...
                log("Responce header " + this.getResponseHeader("Date"))

                log("Responce text " + this.responseText)
                log("Local date " + responseTime)
